        ...
        <div className="flex-1 flex flex-col sm:flex-row overflow-hidden">
          ...
          <div className="w-full sm:w-1/2 p-4 sm:p-6 relative">
            <div className="h-full rounded-2xl overflow-hidden shadow-xl border border-gray-200 relative bg-gradient-to-br from-gray-50 to-white">
              ...
              {currentStep === 2 && (
                <div className="h-full bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center p-8">
                  <div className="text-center space-y-6">
              ...
              {currentStep === 3 && (
                <div className="h-full bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-8">
                  <div className="text-center space-y-6">
                    <div className={`bg-gradient-to-br ${currentStepData.gradient} p-6 rounded-2xl shadow-lg mx-auto w-fit`}>
